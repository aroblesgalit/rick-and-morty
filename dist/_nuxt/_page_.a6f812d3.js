import{g as B,_ as L}from"./CharacterCard.b06fca6c.js";import{_ as P}from"./nuxt-link.72a31963.js";import{s as S,e as q,i as D,j as E,c as n,a as d,F as I,r as j,u as e,t as u,g as m,h as f,k as x,l as A,o,f as F,b as v}from"./entry.f7fd996c.js";import{u as R}from"./characters.e5d2de10.js";const M={class:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6"},O={class:"flex justify-end items-center gap-x-4 my-6"},Q={class:"flex gap-x-2"},z={key:0},G={key:1},X={__name:"[page]",async setup(H){let i,g;const p=R(),{addCharacterToList:y,addPage:w,setTotalChars:C}=p,{charactersList:b,pages:k,totalChars:N}=S(p),{page:s}=q().params,V=B`
