import{g as $,_ as B}from"./CharacterCard.fefdc206.js";import{_ as L}from"./nuxt-link.f8ae6cb6.js";import{s as P,a as S,w as T,h as q,b as c,e as l,F as D,r as E,u as e,t as g,i as f,j as x,k as v,l as I,o,c as j,m as y}from"./entry.d1bd54c1.js";import{u as A}from"./characters.f2913f94.js";const F={class:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6"},R={class:"flex justify-end items-center gap-x-4 my-6"},M={class:"flex gap-x-2"},O={key:0},Q={key:1},U={__name:"[page]",async setup(z){let n,u;const p=A(),{addCharacterToList:w,addPage:C}=p,{charactersList:b,pages:_}=P(p),{page:a}=S().params,k=$`
