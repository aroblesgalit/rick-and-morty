import{g as d,_ as g}from"./CharacterCard.b06fca6c.js";import{_ as m}from"./nuxt-link.72a31963.js";import{i as p,j as h,c as a,a as t,F as x,r as f,u as o,t as y,g as n,h as v,l as w,o as r,b as C}from"./entry.f7fd996c.js";const N={class:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6"},b={class:"flex justify-end items-center gap-x-4 my-6"},k={class:"flex gap-x-2"},F={__name:"index",async setup(q){let e,c;const i=d`
    query getCharacters() {
        characters() {
            info {
                count
