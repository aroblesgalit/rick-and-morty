import{g as B,_ as L}from"./CharacterCard.c94cf489.js";import{_ as P}from"./nuxt-link.4b6cea43.js";import{s as S,a as q,w as D,b as E,e as n,f as d,F as I,r as j,u as e,t as u,i as m,j as f,k as x,l as A,o,c as F,m as v}from"./entry.73436de9.js";import{u as R}from"./characters.a977d4a0.js";const M={class:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6"},O={class:"flex justify-end items-center gap-x-4 my-6"},Q={class:"flex gap-x-2"},z={key:0},G={key:1},X={__name:"[page]",async setup(H){let i,g;const p=R(),{addCharacterToList:y,addPage:w,setTotalChars:C}=p,{charactersList:b,pages:k,totalChars:N}=S(p),{page:s}=q().params,V=B`
