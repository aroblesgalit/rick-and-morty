...
<script setup>
    const { page, info, results } = defineProps(['page', 'info', 'results']);
    let pageInt = parseInt(page);
    const firstNum = (20 * pageInt) - 19;
    const lastNum = firstNum + 19;
</script>
