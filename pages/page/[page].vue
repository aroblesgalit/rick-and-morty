...
const { addCharacterToList, addPage, setCharactersInfo } = charactersStore;
const { charactersList, pages, charactersInfo } = storeToRefs(charactersStore);
