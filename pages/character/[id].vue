<template>
    <div>
        <a class="rounded bg-[#00b5cc] text-white px-2 py-1 hover:bg-[#e89ac7] text-sm" href="" @click.prevent="$router.back()">Go back</a>
        <div class="flex flex-col md:flex-row gap-4 mt-4">
            <div class="basis-full md:basis-1/2">
                <img class="md:w-full rounded-lg" :src="characterDetail.image" :alt="characterDetail.name">
            </div>
            <div class="char-details basis-full md:basis-1/2 relative p-2 pl-0">
